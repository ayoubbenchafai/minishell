...
SRC = minishell.c ft_functions/ft_malloc.c node.c pwd.c cd.c env.c  signals.c ft_functions/ft_strjoin.c ft_functions/ft_strncmp.c \
	...
	ft_functions/ft_atoi.c exit.c echo.c unset.c ft_functions/ft_ft_strdup.c ft_functions/ft_ft_strjoin.c \
	expand.c utils1.c utils2.c utils3.c utils4.c heredoc.c errors.c parse1.c parse2.c execution.c
OBJ = $(SRC:.c=.o)
